...
public class App {
	...
	private static final String MAIN_MENU_OPTION_REQUEST_BUCKS = "*Under Maintenance* Request TE bucks";
	private static final String MAIN_MENU_OPTION_VIEW_PENDING_REQUESTS = "*Under Maintenance* View your pending requests";
	...
	public void run() {
		...
		System.out.println("***********************************************");
		System.out.println("Developed By Ha Nguyen and Brandon Wakefield");
	...
	private void viewCurrentBalance() {
		...
		System.out.println("Current Balance : TE$" + f.format(userBalance));
	}
	...
	private void sendBucks() {
		...
		if (userBalance.compareTo(userAmountToSend) < 0) {
			...
			console.clearConsole();
			System.out.println("Who do you want to send TE$" + f.format(userAmountToSend) + " to?\n");
			...
			while (true) {
				...
				if (userTo.getId().equals(this.currentUser.getUser().getId())) {
					...
					System.out.println("Your transfer is approved! You sent TE$" + f.format(userAmountToSend) + " to " +
					userTo.getUsername() + ".");
					break;
				}
			}
